# dtc_cat_test_ULTRA_VERBOSE_FEEDBACK.py
import numpy as np
...
for i in range(1, steps):
    ...
    if i in progress_checkpoints:
        ...
        print(f"[{percentage:.0f}%] Simulation progress check.") # FEEDBACK POINT: PROGRESS
...
print("[100%] Simulation complete.") # FEEDBACK POINT 2: SIMULATION ENDED
...
# === PLOT GENERATION ===
print("\n[NEXT STEP] Generating plots and saving files...") # FEEDBACK POINT 3: PLOTTING START
file_success = False
...
try:
    ...
    if not plot_attempted:
        file_error = "Script crashed before plotting started. " + file_error
...
if file_success:
    ...
    print(f"❌ Plotting/File Saving FAILED: {file_error}") # FEEDBACK POINT 4: ERROR REPORT
