...
try:
    ...
    backend_status = "Failed to set Agg backend"
...
try:
    ...
    # ... (SIMULATION FAILURE TRAP OMITTED for brevity but kept in original) ...
...
if simulation_success:
    ...
    try:
        ...
        # ... (PLOTTING CODE OMITTED for brevity but kept in original) ...
        plt.subplot(2,1,1)
    ...
    if file_success:
        ...
        print("Check your directory for dtc_cat_test_RESULT.png/pdf.")
    else:
        print(f"❌ PLOTTING FAILED: {file_error}") 

    # *** THIS IS THE KEY LINE: IMMEDIATE EXIT ***
    sys.exit()
